...
export function normalizeBlog(entry) {
    ...
    return {
        ...
        date: d.date || entry.createdDate,
        slug: d.slug || d.Slug || '',
        thumbnail: d.thumbnail || d.image || '',
        tags: d.tags || [], // list of strings
        links: normalizeBlogLinks(d.links), // helper
        // ...
    };
}

function normalizeBlogLinks(val) {
    // Logic to parse links field (list of objects with url, label)
